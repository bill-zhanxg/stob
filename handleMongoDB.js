        ...
        while (true) {
            if (waiting[0] == num) {
                ...
                try {
                    ...
                    let object = await warnSchemas.findOneAndUpdate({
                        id: guildId,
                        userId: userId
                    }, {
                        $inc: {
        ...
        while (true) {
            if (waiting[0] == num) {
                ...
                try {
                    ...
                    if (value == null) {
                        await disableCommandSchemas.updateOne({
                            guild: guildId
                        }, {
                            commands: [command]
                        }, {
                ...
                try {
                    ...
                    if (value != null) {
                        ...
                        if (value.commands.length < 1) {
                            await disableCommandSchemas.deleteOne({
                                guild: guildId
                            }).exec()
                        }
                        else {
